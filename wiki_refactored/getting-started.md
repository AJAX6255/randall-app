...
3. **Run the refactored dashboard**:
   ```bash
...
The dashboard automatically calculates date ranges for the last 60 business days. Key configuration variables in `complex_dash_refactored.py`:
...
- `ETF_SYMBOLS` dictionary - Maps ETF symbols to display names
